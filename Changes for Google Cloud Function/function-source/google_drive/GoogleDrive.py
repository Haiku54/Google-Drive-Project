...
class ClassGoogleDrive(Singleton):
    ...
    def copy_public_file_to_my_drive(self, request_id): 
        ...
        try:
            ...
            #original_file_metadata = self.service.files().get(fileId=public_file_id,supportsAllDrives=True).execute()
            original_file_name = file['name']
            resourche_key = file.get('resourceKey', '')
            original_file_description = file.get('description', '')
